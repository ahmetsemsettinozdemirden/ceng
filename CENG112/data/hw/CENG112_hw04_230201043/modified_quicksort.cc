...
template <typename T>
int partition(T *x, int l, int r, cmp_func<T> cmp);

// void quicksort(int *x, int l, int r, cmp_func cmp);

template <typename T>
void insertion_sort(T *x, int l, int r, cmp_func<T> cmp);

template <typename T>
void quicksort_r(T *x, int l, int r, cmp_func<T> cmp);

template <typename T>
void quicksort2(T *x, int l, int r, cmp_func<T> cmp);
